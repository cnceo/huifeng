<style type="text/css">
.a7{background-position: -32px -288px;}
.a7color{color: #08a09d}
...
.user_column a{margin-left:54px;line-height:28px;}
            ...
            <h4>
                <i class="icon_3 homeicon"></i>代理中心</h4>
            <a href="?tnt=tml" class="current">代理管理</a>
            <a href="?tnt=tca" class="current">团队统计</a>
            <a href="?tnt=tgr" class="current">投注记录</a>
            <a href="?tnt=trt" class="current">团队盈亏</a>
            <a href="?tnt=tc" class="current">会员帐变</a>
            <a href="?tnt=tcr" class="current">提现记录</a>
            <a href="?tnt=tll" class="current">推广链接</a>
        </div>
        <?php } ?>
        <div class="user_column">
