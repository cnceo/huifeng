    ...
    <div class="page-info">
    	...
    	<form action="<?=$this->basePath('Safe-setPasswd') ?>" method="post" target="ajax" onajax="safeBeforSetPwd" call="safeSetPwd">
                <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td><input type="password" name="newpassword" id="newpass"/><span class="pop"><s class="pop-l"></s><span>
						<p>　( 由字母和数字组成6-16个字符；且必须包含数字和字母，不能和资金密码相同 ) </span><s class="pop-r"></s></span></td>
                    </tr>
                    <tr>
...
<form action="<?=$this->basePath('Safe-setCoinPwd2') ?>" method="post" target="ajax" onajax="safeBeforSetCoinPwd2" call="safeSetPwd">
                <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td><input type="password" name="newpassword" id="newpass"/><span class="pop"><s class="pop-l"></s><span>
						<p>　( 由字母和数字组成6-16个字符；且必须包含数字和字母，不能和登录密码相同 ) </span><s class="pop-r"></s></span></td>
                    </tr>
                    <tr>
...
<form action="<?=$this->basePath('Safe-setCoinPwd') ?>" method="post" target="ajax" onajax="safeBeforSetCoinPwd" call="safeSetPwd">
                <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td class="tdtitle">输入新资金密码: </td>
                        <td>
                            <input type="password" name="newpassword" id="securitynewpass"/><span class="pop"><s class="pop-l"></s><span> (由字母和数字组成6-16个字符；且必须包含数字和字母，不能和登录密码相同) </span><s class="pop-r"></s></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="tdtitle">确认新资金密码: </td>
