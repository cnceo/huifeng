	 ...
	 <?php if($this->user['coinPassword']){ ?>
        <div class="page_list">
            <div class="help">
                ...
                <p>1. 银行卡绑定成功后，请您仔细核实您的资料信息, 开户姓名等信息。</p>
   ...
   <table border="0" cellpadding="0" cellspacing="0">
    <tbody>
	 ...
	 <tr>
       ...
       <td>
       <input placeholder="由1至30个字符或汉字组成, 不能使用特殊字符" name="username" value="<?=$myBank['username']?>" <?=$this->iff($flag, 'readonly')?> size="15" type="text" />
       </td>
	 </tr>
	  <tr>
       <td class="tdtitle"><font color="#FF0000">*</font>&nbsp;开户支行名称:</td>
       <td>
       <input placeholder="由1至30个字符或汉字组成, 不能使用特殊字符" name="countname" value="<?=$myBank['countname']?>" <?=$this->iff($flag, 'readonly')?> size="30" type="text" />
       </td>
	 </tr>
	 <tr>
       <td class="tdtitle"><font color="#FF0000">*</font>&nbsp;<span id="banknameinfo_1">银行账号</span>:</td>
       <td style="position: relative;">
                            <input style="background: none repeat scroll 0% 0% rgb(238, 238, 238); border: 1px solid rgb(221, 221, 221);"  class="needdesc" maxlength="19" name="account" id="account" size="30" type="text" value="<?=$myBank['account']?>" <?=$this->iff($flag, 'readonly')?> />
                       </td>
                    </tr>
					 <tr>
