...
<p>对自己绑定在平台的银行卡进行管理，进入管理之前需要验证资金密码无误，进入银行卡页面后可以&ldquo;绑定新的银行卡&rdquo;、&ldquo;解绑银行卡&rdquo;、&ldquo;锁定银行卡&rdquo;、&ldquo;解锁银行卡&rdquo;，<span style="color: rgb(255, 0, 0); ">每次锁定银行卡后只可解锁1次</span>。</p>
