...
.modal-body ul{ position:absolute;width:800px;text-align: left}
.modal-body li{float: left;width:200px;margin:10px 30px 10px 30px;}
.modal-body li em{width: 200px;}
.modal-body li span{width: 200px;}
</style>
   ...
   <div class="modal-body" >
    <ul>
	  ...
	  <li></li><li></li>
	  <li style="width: auto;"><em>投注内容：</em><br /><div style="overflow-x:auto;overflow-y:auto;height:100px;width: 740px;"><p style="word-break:break-all;"><br /><?=$wei.$bet['actionData']?></p></div></li>  
	</ul>
   </div>
