...
?>
	...
	<script>
		...
		ga('create', 'UA-49350907-1', 'Thor qq1154751577');
		ga('send', 'pageview');
	</script>
</head>
<body style="background:none;background:#1C1C1C;">
	<div id="right_01">
...
<style>
	esun\:*{behavior:url(#default#VML)}
			...
			<div class="search">
				<table width="980px" id="titlemessage" border="0" cellpadding="0" cellspacing="0" style="background:#2A2A2A;margin:0 auto">
					<tr>
						<td><b><span class="redtext" style="color:silver;"><?=$this->types[$type]['title'] ?>基本走势</span></b></td>
						<td>
							<a href="?tnt=crt&type=<?=$type ?>&count=30" style="text-decoration: none;color:silver;margin:0 10px">最近30期</a>
							<a href="?tnt=crt&type=<?=$type ?>&count=50" style="text-decoration: none;color:silver;margin:0 10px">最近50期</a>
							<a href="?tnt=crt&type=<?=$type ?>&count=100" style="text-decoration: none;color:silver;margin:0 10px">最近100期</a>
						</td>
						<!-- td>
							<form method="post">
			...
			<table align="center">
				 <tr>
				  <td colspan="3" style="border:0px;color:#fff">
...
<div style="position:relative;width:1050px;height: 950px;background:#EEEEEE;margin:0 auto" id="container">
