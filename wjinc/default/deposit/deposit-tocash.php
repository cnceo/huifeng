...
<div class="page-wrapper">
    ...
    <div class="page-info">
		...
		<table><tr>
		<td> <a href="<?=$this->basePath('Deposit-pull') ?>" dataType="json" call="pull" target="ajax" class="btn btn1 btn-action">领取收益</a>
    ...
    <div class="display biao-cont">     
	 <form action="<?=$this->basePath('Deposit-outdeposit') ?>" method="post" target="ajax" onajax="checkDeposit" call="toDeposit">
    ...
    <tr height=25 class='table_b_tr_b'>
      ...
      <td align="left" ><input name="amount" id="ContentPlaceHolder1_txtMoney" type="text" value="" onkeyup="showPaymentFee();"/></td>
    </tr>
	<tr height=25 class='table_b_tr_b'>
	...
	<tr height=25 class='table_b_tr_b'>
     ...
     <tr height=25 class='table_b_tr_b'>
      ...
      <td align="left"><input type="button" id='put_button_pass' class="btn darwingbtn btn-action" value="确认转出" style="width:100px;"  onclick="$(this).closest('form').submit()"> </td> 
    </tr> 
</table> 
</form>
</div>
