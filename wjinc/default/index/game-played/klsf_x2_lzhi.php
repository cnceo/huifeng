...
<?php foreach(array('前位','后位') as $var){ ?>
<div class="pp pp11" delimiter=" " action="tzAllSelect" length="2" >
...
<!--input type="button" value="01" class="code code_2 d min" />
	<input type="button" value="02" class="code code_2 s min" />
	<input type="button" value="03" class="code code_2 d min" />
	<input type="button" value="04" class="code code_2 s min" />
	<input type="button" value="05" class="code code_2 d min" />
	<input type="button" value="06" class="code code_2 s min" />
	<input type="button" value="07" class="code code_2 d min" />
	<input type="button" value="08" class="code code_2 s min" />
	<input type="button" value="09" class="code code_2 d min" />
	<input type="button" value="10" class="code code_2 s min" />
	<input type="button" value="11" class="code code_2 d max" />
	<input type="button" value="12" class="code code_2 s max" />
	<input type="button" value="13" class="code code_2 d max" />
	<input type="button" value="14" class="code code_2 s max" />
	<input type="button" value="15" class="code code_2 d max" />
	<input type="button" value="16" class="code code_2 s max" />
	<input type="button" value="17" class="code code_2 d max" />
	<input type="button" value="18" class="code code_2 s max" />
	<input type="button" value="19" class="code code_2 d max" />
	<input type="button" value="20" class="code code_2 s max" />
	<div class="clearfix"></div>
	<input type="button" value="清" class="action action_2 none" />
    <input type="button" value="双" class="action action_2 even" />
    <input type="button" value="单" class="action action_2 odd" />
