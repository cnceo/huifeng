...
<div class="page-wrapper">
    <?php $this->display('inc_left_4.php'); ?><div class="top_menu">
        <a class="act" href="<?= $this->basePath('Score-goods') ?>">积分兑换</a>
        <a></a>
    </div>
    <div class="page-info">
	  <div class="page_list">
	  <!-- begin -->
<div class="zzsc-list" style="margin-left:7px;margin-bottom:20px;">
            <?php
                if($args[0]) foreach($args[0]['data'] as $var){
            ?>
    <!-- 开始模块 -->
    <div class="dressing" style="width:190px; margin-top:30px;">    
      <div class="dressing_wrap">
        <div class="skinimg"><a href="javascript:void(0)"><img src="/<?=$var['picmax']?>" width="190" height="130" /></a></div>
        <div class="information_area">
          <div class="information_area_wrap">
            ...
            <div class="tipinfo clearfix">
			  ...
			  <a <?=$this->iff($this->formatGoodTime($var['startTime'], $var['stopTime'])!='已结束','title="点击参与" href="'.$this->basePath('Score-swap',$var['id']).'"','')?> style="display:block;" class="buybtn"><span>兑换积分</span></a>
			  <?php
					if($var['state']){
